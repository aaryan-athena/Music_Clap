...
3. Get the best matching tone type and settings

### Example Text Inputs
- **Heavy/Metal**: "heavy metal", "aggressive distortion", "brutal tone"
- **Clean**: "clean guitar", "pristine sound", "jazz clean"
- **Crunch**: "vintage crunch", "blues overdrive", "classic rock"
- **Ambient**: "spacey guitar", "ethereal tone", "shoegaze reverb"
...
- **Text Features**: CLAP text embeddings with cosine similarity matching
...
- **Text Matching Accuracy**: 87.5% on semantic descriptions
